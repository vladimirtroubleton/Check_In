...
namespace Check_In.Services
{
    public class AuthService : IAuthService
    {
        ...
        {
            var url = new Uri("https://localhost:44388/api/AccountManager/Register").AbsoluteUri;
        ...
        {
            var url = new Uri("https://localhost:44388/api/AccountManager/Login").AbsoluteUri;
